package project.gregica.common.tileentities.mte;
...
import project.gregica.api.mte.HatchType;
import project.gregica.api.recipe.GCRecipeMaps;
import project.gregica.client.GCTextures;
import project.gregica.common.tileentities.mte.multi.energy.MTEActiveTransformer;
import project.gregica.common.tileentities.mte.multi.energy.MTELapotronicSuperCapacitor;
import project.gregica.common.tileentities.mte.multi.generators.MTEEssentiaGenerator;
import project.gregica.common.tileentities.mte.multi.machines.*;
import project.gregica.common.tileentities.mte.multipart.*;
import project.gregica.common.tileentities.mte.single.MTECreativeGenerator;
import net.minecraft.util.ResourceLocation;
import project.gregica.module.gcys.common.metatileentities.*;
...
public class GCMetaEntities {
    ...
    public static MTESawmill SAWMILL;
    ...
    private static void initMultiBlock(){
        ...
        SAWMILL = registerMetaTileEntity(nextMultiBlockID(), new MTESawmill(gcID("sawmill")));
        //含联动的放最底下
