...
import me.oganesson.gregica.GCCfg;
import me.oganesson.gregica.common.GCPPUtility;
...
public class QubitConsumerRecipeBuilder extends RecipeBuilder<QubitConsumerRecipeBuilder> {
    ...
    static {
            for (String fluid : GCCfg.Misc.solderingFluidList) {
            String[] fluidSplit = fluid.split(":");
            int amount = GCPPUtility.setBetweenInclusive(Integer.parseInt(fluidSplit[1]), 1, 64000);
