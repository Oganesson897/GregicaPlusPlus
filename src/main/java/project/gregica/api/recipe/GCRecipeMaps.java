package project.gregica.api.recipe;
...
import project.gregica.api.capability.chemical_plant.ChemicalPlantBuilder;
import project.gregica.api.capability.isa_mill.IsaMillBuilder;
import project.gregica.api.capability.quantum.QubitConsumerRecipeBuilder;
import project.gregica.api.capability.quantum.QubitProducerRecipeBuilder;
import project.gregica.api.recipe.builders.NoCoilTemperatureRecipeBuilder;
import project.gregica.api.recipe.machines.RecipeMapSuprachronalAssembler;
import project.gregica.client.render.GCYSGuiTextures;
...
public class GCRecipeMaps {
    ...
    public static final RecipeMap<SimpleRecipeBuilder> HEAT_EXCHANGER = new RecipeMap<>("heat_exchanger",  0, 0, 1, 1, new SimpleRecipeBuilder(), false);

    public static final RecipeMap<SimpleRecipeBuilder> SAWMILL = new RecipeMap<>("sawmill", 2, 2, 1, 0, new SimpleRecipeBuilder(), false)
