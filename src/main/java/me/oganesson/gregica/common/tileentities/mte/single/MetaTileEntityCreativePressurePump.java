...
public class MetaTileEntityCreativePressurePump extends MetaTileEntity {
    ...
    private double particles = GCValues.EARTH_PRESSURE;
    ...
    public <T> T getCapability(Capability<T> capability, EnumFacing side) {
        if (capability == GCCapabilities.CAPABILITY_PRESSURE_CONTAINER) {
            return GCCapabilities.CAPABILITY_PRESSURE_CONTAINER.cast(this.pressureContainer);
        }
    ...
    public void update() {
        ...
        for (EnumFacing facing : EnumFacing.values()) {
            ...
            if (tile != null) {
                IPressureContainer container = tile.getCapability(GCCapabilities.CAPABILITY_PRESSURE_CONTAINER, facing.getOpposite());
                if (container == null) continue;
                if (container.getPressure() != GCValues.EARTH_PRESSURE &&
