...
public class MetaTileEntityIndustrialDrill extends RecipeMapMultiblockController {
    ...
    public MetaTileEntityIndustrialDrill(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GCRecipeMaps.DRILLING_RECIPES);
    ...
    protected ICubeRenderer getFrontOverlay() {
        return GCTextures.INDUSTRIAL_DRILL_OVERLAY;
    }

    @Override
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        super.addInformation(stack, player, tooltip, advanced);
        tooltip.add(I18n.format("gregica.multiblock.industrial_drill.tooltip.1"));
        tooltip.add(I18n.format("gregica.multiblock.industrial_drill.tooltip.2"));
    }
