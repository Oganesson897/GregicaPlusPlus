...
public class MetaTileEntityAxialCompressor extends MultiblockWithDisplayBase implements IWorkable {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('P', abilities(GCCapabilities.PRESSURE_CONTAINER))
                .build();
    }
    ...
    protected ModularUI.Builder createUITemplate(EntityPlayer entityPlayer) {
        ...
        if (this.isStructureFormed()) {
            ...
            builder.widget(new TextFieldWidget2(12, 108, 112, 16, () -> String.valueOf(targetPressure), value -> {
                if (!value.isEmpty()) targetPressure = Math.max(GCValues.EARTH_PRESSURE, Math.min(Double.parseDouble(value), maxPressure));
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gregica.multiblock.axial_compressor.tooltip.1",
                NumberFormattingUtil.formatDoubleToCompactString(this.pressureRate),
                NumberFormattingUtil.formatDoubleToCompactString(this.maxPressure), I18n.format(GCValues.PNF[GCUtil.getTierByPressure(this.maxPressure)])));
        tooltip.add(I18n.format("gregica.multiblock.axial_compressor.tooltip.2", FLUID_USE_AMOUNT));
        tooltip.add(I18n.format("gregica.multiblock.axial_compressor.tooltip.3", I18n.format(GTValues.VNF[this.tier])));
    }
    ...
    protected ICubeRenderer getFrontOverlay() {
        if (tier == GTValues.LuV) {
            return GCTextures.SUPERSONIC_AXIAL_COMPRESSOR_OVERLAY;
        }

        return GCTextures.SUBSONIC_AXIAL_COMPRESSOR_OVERLAY;
    }
