package project.gregica.loader.recipes.component;
...
import static project.gregica.api.unification.materials.GCMaterials.*;
import static project.gregica.module.gcys.api.unification.materials.material.GCYSMaterials.*;
...
//                {13, new UnificationEntry(OrePrefix.rotor, Trinium)},
        ...
        GRINDER.appendIngredients(Stream.of(new Object[][]{
                ...
                {9, GCMetaItems.COMPONENT_GRINDER_BORON_NITRIDE.getStackForm()},
                {10, GCMetaItems.COMPONENT_GRINDER_BORON_NITRIDE.getStackForm()},
                {11, GCMetaItems.COMPONENT_GRINDER_BORON_NITRIDE.getStackForm()},
//                {12, GCMetaItems.},
//                {13, GCMetaItems.},
        }).collect(Collectors.toMap(data -> (Integer) data[0], data -> data[1])));
...
//                {13, new UnificationEntry(OrePrefix.pipeHugeFluid, Trinium)},
        ...
        POWER_COMPONENT.appendIngredients(Stream.of(new Object[][]{
                {9, GCMetaItems.NANO_POWER_IC},
                {10, GCMetaItems.NANO_POWER_IC},
                {11, GCMetaItems.PICO_POWER_IC},
                {12, GCMetaItems.PICO_POWER_IC},
                {13, GCMetaItems.FEMTO_POWER_IC},
                {14, GCMetaItems.FEMTO_POWER_IC},
        }).collect(Collectors.toMap(data -> (Integer) data[0], data -> data[1])));

        VOLTAGE_COIL.appendIngredients(Stream.of(new Object[][]{
                {9, GCMetaItems.VOLTAGE_COIL_UHV},
                {10, GCMetaItems.VOLTAGE_COIL_UEV},
                {11, GCMetaItems.VOLTAGE_COIL_UIV},
                {12, GCMetaItems.VOLTAGE_COIL_UXV},
                {13, GCMetaItems.VOLTAGE_COIL_OpV},
                {14, GCMetaItems.VOLTAGE_COIL_MAX},
        }).collect(Collectors.toMap(data -> (Integer) data[0], data -> data[1])));
