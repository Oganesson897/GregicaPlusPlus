    ...
    public void update() {
        ...
        if (getQubitStored() >= getOutputQubit() && getOutputQubit() > 0 && getOutputParallel() > 0) {
            ...
            for (EnumFacing side : EnumFacing.VALUES) {
                ...
                if (tileEntity != null && tileEntity.hasCapability(GCPPCapabilities.QBIT_CAPABILITY, oppositeSide)) {
                    IQubitContainer qubitContainer = tileEntity.getCapability(GCPPCapabilities.QBIT_CAPABILITY, oppositeSide);
