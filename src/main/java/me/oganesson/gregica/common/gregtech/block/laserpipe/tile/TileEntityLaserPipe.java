...
import me.oganesson.gregica.common.gregtech.block.laserpipe.net.LaserPipeNet;
import me.oganesson.gregica.common.gregtech.block.laserpipe.net.PipeLaserContainer;
import me.oganesson.gregica.common.gregtech.block.laserpipe.net.WorldLaserNet;
...
public class TileEntityLaserPipe extends TileEntityPipeBase<LaserPipeType, EmptyNodeData> {
    ...
    public <T> T getCapabilityInternal(Capability<T> capability, @Nullable EnumFacing facing) {
        if(capability == GCPPCapabilities.QBIT_CAPABILITY) {
            return GCPPCapabilities.QBIT_CAPABILITY.cast(getLaserContainer());
        }
    ...
    public IQubitContainer findLaserContainer(EnumFacing facing) {
        ...
        while (laserContainer == null) {
            ...
            if(tile instanceof TileEntityLaserPipe)
                continue;
            laserContainer = tile.getCapability(GCPPCapabilities.QBIT_CAPABILITY, facing.getOpposite());
        }
        return laserContainer;
    }
