...
import project.gregica.api.capability.quantum.QubitRecipeMapMultiblockController;
...
public class MTEAssemblyLine extends QubitRecipeMapMultiblockController {
    ...
    public MTEAssemblyLine(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GCRecipeMaps.ASSEMBLY_LINE_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MTEAssemblyLine(metaTileEntityId);
    }
    ...
    protected @NotNull BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start(FRONT, UP, RIGHT)
                ...
                .where('Q', abilities(GCCapabilities.INPUT_QBIT))
                ...
                .where('#', any())
                .where('L', inputPredicate())
                .build();
    }

    private TraceabilityPredicate inputPredicate() {
        return metaTileEntities(MetaTileEntities.ITEM_IMPORT_BUS[0]);
    }
