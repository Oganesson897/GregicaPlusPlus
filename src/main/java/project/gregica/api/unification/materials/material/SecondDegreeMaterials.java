...
import static project.gregica.api.unification.materials.info.GCMaterialFlags.GENERATE_MILLED;
...
public class SecondDegreeMaterials {
    ...
    public static void register() {
        ...
        GCMaterials.SuperheatedSteam = new Material.Builder(26132, "superheated_steam")
                .fluid(FluidTypes.GAS, true)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                .components(Materials.Hydrogen, 2, Materials.Oxygen, 1)
                .fluidTemp(553)
                .build();
