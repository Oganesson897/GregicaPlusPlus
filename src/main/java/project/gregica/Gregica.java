...
import project.gregica.client.render.BlocksHighlightRenderer;
...
public class Gregica {
    ...
    @SidedProxy(clientSide = "project.gregica.api.ClientProxy", serverSide = "project.gregica.api.CommonProxy")
