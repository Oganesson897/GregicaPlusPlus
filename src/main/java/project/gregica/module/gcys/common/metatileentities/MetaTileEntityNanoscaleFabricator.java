...
import project.gregica.module.gcys.common.metablocks.BlockCrucible;
import project.gregica.module.gcys.common.metablocks.BlockGCYSMultiblockCasing;
...
public class MetaTileEntityNanoscaleFabricator extends RecipeMapMultiblockController { //TODO Pressure for this machine
    ...
    public MetaTileEntityNanoscaleFabricator(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GCRecipeMaps.MOLECULAR_BEAM_RECIPES);
    ...
    protected ICubeRenderer getFrontOverlay() {
        return GCTextures.NANOSCALE_FABRICATOR_OVERLAY;
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gregica.multiblock.nanoscale_fabricator.tooltip.1"));
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder()
                ...
                .aisle("   TTT   ", "   TIT   ", "   TCT   ", "         ")
                .where('S', GCMetaEntities.NANOSCALE_FABRICATOR, EnumFacing.SOUTH)
