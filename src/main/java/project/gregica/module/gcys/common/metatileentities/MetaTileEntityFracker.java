...
public class MetaTileEntityFracker extends MultiblockWithDisplayBase implements IWorkable, ITieredMetaTileEntity {
    ...
    protected ICubeRenderer getFrontOverlay() {
        return GCTextures.FRACKER_OVERLAY;
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gregica.multiblock.fracker.tooltip.1"));
        tooltip.add(I18n.format("gregica.multiblock.fracker.tooltip.2", GTUtility.formatNumbers(GTValues.VA[tier])));
    }
