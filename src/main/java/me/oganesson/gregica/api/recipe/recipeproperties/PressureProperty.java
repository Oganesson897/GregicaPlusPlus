package me.oganesson.gregica.api.recipe.recipeproperties;
...
public class PressureProperty extends RecipeProperty<Double> {
    ...
    public void drawInfo(@Nonnull Minecraft minecraft, int x, int y, int color, Object value) {
        ...
        minecraft.fontRenderer.drawString(I18n.format(casted > 1 ? "gregica.recipe.pressure" : "gregica.recipe.vacuum",
