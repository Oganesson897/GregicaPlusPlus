package me.oganesson.gregica.common.gregtech.block.laserpipe;
...
import me.oganesson.gregica.common.gregtech.block.laserpipe.tile.TileEntityLaserPipeTickable;
...
public class BlockLaserPipe extends BlockSimplePipe<LaserPipeType, EmptyNodeData, WorldLaserNet> {
    ...
    public boolean canPipeConnectToBlock(IPipeTile iPipeTile, EnumFacing enumFacing, @Nullable TileEntity tileEntity) {
        return tileEntity != null && tileEntity.hasCapability(GCPPCapabilities.QBIT_CAPABILITY, enumFacing.getOpposite());
    }
